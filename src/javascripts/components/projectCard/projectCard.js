...
const createProjectCards = () => {
  ...
  domString += '<img src="https://live.staticflickr.com/65535/49932153253_f0e8db529b_c.jpg" class="d-block w-100" alt="Product cards of candy">';
  ...
  domString += '<img src="https://live.staticflickr.com/65535/49932974957_43d1d5a63d_c.jpg" class="d-block w-100" alt="Card of animals">';
  domString += '<div class="carousel-caption d-none d-md-block">';
  ...
  domString += '</div>';
  domString += '<div class="carousel-item">';
  domString += '   <img src="https://live.staticflickr.com/65535/49932975682_ec93f6c9fa_c.jpg" class="d-block w-100" alt="...">';
  domString += '<div class="carousel-caption d-none d-md-block">';
  domString += '<h5>Bear Watcher</h5>';
  domString += '<p>Technologies used are HTML, CSS, Javascript and Github version control.</p>';
  domString += '<a href="https://github.com/Michele-Rawlins/bearWatcher"></a>';
  domString += 'div class="carousel-item">';
  domString += '  <img src="https://live.staticflickr.com/65535/49932152628_a2fcda80d3_c.jpg" class="d-block w-100" alt="...">';
  domString += '  <div class="carousel-caption d-none d-md-block">';
