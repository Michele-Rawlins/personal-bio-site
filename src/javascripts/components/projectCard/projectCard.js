    ...
    .then((projectsList) => {
      ...
      projectsList.forEach((finishedProjects) => {
        if (finishedProjects.available === true) {
          ...
          domString += '<div></div>';
          domString += `<a class="project-text-url" href =${finishedProjects.url}><span class="text-target"><span>${finishedProjects.url}</a>`;
          domString += '<div></div>';
          domString += `<a class="project-text-git" href =${finishedProjects.githubUrl}>${finishedProjects.githubUrl}</a>`;
          domString += '</div>';
          domString += '</div>';
          // domString += '</div>';
          // domString += '</div>';
