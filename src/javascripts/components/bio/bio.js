...
const createBio = () => {
  ...
  domString += '<p class="bio-text">Hello!!!     My name is Michele Rawlins.     I am a Full Stack Web Developer.    Current Skill Stack: Javascript, React, Sass, C#, ASPNET.MVC, SQL, .NetCore and an eternal thirst for knowledge.  I have worked in manufacturing and the food industry for the last 32 years.  I look forward to discussing your vision.</p>';
