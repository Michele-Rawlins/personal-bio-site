...
const createBio = () => {
  ...
  domString += '<p> Motivated, goal-oriented and driven business professional.(Just completed a year long part-time Web Developemnt Bootcamp while working full-time).</p>';
  domString += '<p> How is that for motivated and goal-oriented?  I am flexible and versatile and thrive in deadline driven enviroments.</p>';
